...
// (`tools/ferrite-ctl/src/sdr_tables.rs`) owns the table; this file is
// generated by `cargo run -p ferrite-ctl -- gen-tables` and the Rust
// CI test fails if it drifts. Do not hand-edit. Keyed by lowercased
